{{-- Wisata Baru--}}
<div class="wisata__viral wisata__landing__wrapper mt-10 mb-10">
    <div class="wisata__heading">
        <span class="title__wisata__viral">
            <h1 class="mt-16 mb-4">Wisata Baru Jawa Timur</h1>
        </span>
        <div class="wisata__content mt-10 mb-10 flex flex-col md:flex-row xl:flex-row gap-4">
                ...
                <div class="block max-w-sm dark:bg-neutral-700 wisata__viral__card__item">
                    <a href="#!">
                        <figure class="wisata__banner">
                            <img src="https://images.unsplash.com/photo-1663248041121-cc6bc5b83103?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
                                alt="" />
                        </figure>
                    </a>
                    <div class="py-8 card__title__info">
                        ...
                        <div class="card__location__graph flex flex-row gap-3 justify-center m-auto">
                            ...
                            <p class="text-neutral-600 dark:text-neutral-200 card__item__title">
            ...
            <div class="flex flex-row wisata__card">
                <div class="block max-w-sm dark:bg-neutral-700 wisata__viral__card__item">
                    <a href="#!">
                        <figure class="wisata__banner">
                            <img src="https://images.unsplash.com/photo-1655802437200-ddea124855f8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
                                alt="" />
                        </figure>
                    </a>
                    <div class="py-8 card__title__info">
            ...
            <div class="flex flex-row wisata__card">
                <div class="block max-w-sm dark:bg-neutral-700 wisata__viral__card__item">
                    <a href="#!">
                        <figure class="wisata__banner">
                            <img src="https://images.unsplash.com/photo-1527547637224-a93d42c7b332?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
                                alt="" />
                        </figure>
                    </a>
                    <div class="py-8 card__title__info">
                ...
                <div class="block max-w-sm dark:bg-neutral-700 wisata__viral__card__item">
                    <a href="#!">
                        <figure class="wisata__banner">
                            ...
                            <img src="https://images.unsplash.com/photo-1570151579771-14d245e5e9be?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80"
                                alt="" />
                        </figure>
                    </a>
                    <div class="py-8 card__title__info">
        ...
        {{-- See More Button --}}
        <div class="cta__more  relative flex">
            <div
                class="ctaa__link flex flex-row m-auto justify-center top-0 left-0 right-0 bottom-0 align-middle text-center">
                <a href="" class="flex gap-2 align-middle justify-center m-auto hover:underline">
                    Lihat Semua
                    <svg width="6" height="10" class="flex align-middle justify-center m-auto" viewBox="0 0 5 8"
