<div class="wisata__information py-10 relative">
    <div class="wisata__header__inf booking flex items-center justify-between">
        <div class="wisata__title">
            <h1 class="py-4">Wisata De Laponte</h1>
            <div class="rate__location flex items-center gap-2">
                ...
                <span class="rating__indicators font-semibold">4,7</span>
                <span class="inline-block underline font-medium mx-6">Malang, Jawa Timur</span>
            </div>
        </div>
